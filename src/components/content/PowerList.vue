<template>
  <div>
    ...
    <!-- 权限表 添加按钮 -->
    <div class="powerAddBtn">
      <el-button type="success" plain @click="addRole" icon="el-icon-plus">添加角色</el-button>
    </div>
      ...
      :data="filterData2(tableData,searchContent).slice((pagenum-1)*pagesize,pagenum*pagesize)">
        ...
        <el-table-column label="操作" width="350">            
          <template slot-scope="scope">            
            <el-button type="success" @click="showEditDialog(scope.row.roleId)">修改</el-button>
            <el-button type="success" @click="removeRoleById(scope.row.roleId)">删除</el-button>
